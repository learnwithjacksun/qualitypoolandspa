...
import { Facebook, Twitter, Instagram, PhoneCall, Mail, MapPin, ChevronDown, Globe, Menu } from "lucide-react";
      ...
      <div className="w-full bg-white border-b border-gray-200 text-sm hidden md:block">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2">
          ...
          <div className="flex items-center gap-6 text-xs">
            ...
            >
              <MapPin size={14} className="shrink-0" /> Calahonda, Marbella,
              Mallorca, Estepona
            </a>
            <a
          ...
          <div className="flex items-center gap-4">
            ...
            >
              <PhoneCall size={14} className="shrink-0" /> Book a Call
            </a>
            {/* Socials */}
      ...
      <div className="bg-primary text-white shadow-md">
        <nav className="mx-auto flex h-[70px] max-w-7xl items-center justify-between px-4">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            {/* Language Selector */}
            <label className="group relative inline-flex h-10 items-center rounded-full border border-white/35 bg-white/10 pl-3 pr-9 text-sm font-medium text-white backdrop-blur-md transition-all hover:bg-white/15 focus-within:ring-2 focus-within:ring-white/70">
              <Globe size={16} className="mr-2 shrink-0 opacity-90" />
              <select
                className="h-full cursor-pointer font-space appearance-none bg-transparent pr-2 text-sm font-semibold tracking-wide text-white focus:outline-none"
          ...
          <div className="flex md:hidden items-center gap-4">
            <label className="group relative inline-flex h-10 items-center rounded-full border border-white/35 bg-white/10 pl-3 pr-9 text-sm font-medium text-white backdrop-blur-md transition-all hover:bg-white/15 focus-within:ring-2 focus-within:ring-white/70">
              <Globe size={16} className="mr-2 shrink-0 opacity-90" />
              <select
                className="h-full cursor-pointer appearance-none bg-transparent pr-2 text-sm font-semibold tracking-wide text-white focus:outline-none"
                aria-label="Choose language"
                defaultValue="EN"
              >
                <option className="text-black" value="EN">
